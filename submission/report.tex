...
% future work
% > better survey: consult with health professionals and refer from more well established studies in helathy and sleep to discover new and important variables
% > solving data imbalance: besides distributing survyes through the authors' friend and college circles, the future survye should be conducted on a wider range of participants for class balance
% > improving models: given more time and effort in modellings, finetuning current best models could boost predictive powers significantly. also, the authors can consider using different models and methods such as clustering, or even neural works
